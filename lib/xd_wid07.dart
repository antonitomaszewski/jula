...
class XDWid07 extends StatelessWidget {
  XDWid07({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
              ...
              children: <Widget>[
                ...
                Center(
                  child: SizedBox(
                    ...
                    height: 24.0,
                    child:
                        // Adobe XD layer: 'focus-3-line (1)' (group)
                        Stack(
                      children: <Widget>[
                        SizedBox.expand(
                            child: SvgPicture.string(
          ...
          Align(
            alignment: Alignment(0.516, 0.668),
            child: SizedBox(
              width: 40.0,
              height: 40.0,
              child: Stack(
                children: <Widget>[
                  ...
                  Center(
                    child: SizedBox(
                      ...
                      height: 24.0,
                      child:
                          // Adobe XD layer: 'history-line' (group)
                          Stack(
                        children: <Widget>[
                          SizedBox.expand(
                              child: SvgPicture.string(
