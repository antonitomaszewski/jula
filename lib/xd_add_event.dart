...
class XDAddEvent extends StatelessWidget {
  XDAddEvent({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 107.0, start: 44.0),
            Pin(size: 15.0, middle: 0.5764),
            child: Text(
              'Add Date and Time',
              style: TextStyle(
                fontFamily: 'Helvetica Neue',
          ...
          Pinned.fromPins(
            Pin(size: 167.5, middle: 0.5),
            Pin(size: 28.3, end: 98.0),
            child: XDComponent131(),
          ),
          Align(
          ...
          Pinned.fromPins(
            Pin(size: 136.0, middle: 0.5019),
            Pin(size: 18.0, end: 103.2),
            child: Text(
