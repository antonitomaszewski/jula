...
import './xd_profile_place1.dart';
import './xd_component61.dart';
import './xd_component51.dart';
import './xd_my_profile.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDMyProfileSavedPosts extends StatelessWidget {
  XDMyProfileSavedPosts({
    Key? key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          Container(
            ...
            margin: EdgeInsets.fromLTRB(1.0, 29.0, -4.0, 0.0),
          ),
          Align(
            alignment: Alignment(0.544, 0.204),
            child: SizedBox(
              width: 64.0,
              height: 16.0,
              child: Stack(
          ...
          Pinned.fromPins(
            Pin(size: 32.2, middle: 0.1814),
            Pin(size: 23.9, end: 133.6),
            child: Stack(
              children: <Widget>[
                Stack(
                  children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 49.1, middle: 0.8125),
            Pin(size: 28.6, end: 127.0),
            child: Stack(
              children: <Widget>[
                Stack(
                  children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 24.7, middle: 0.2983),
            Pin(size: 24.6, end: 133.6),
            child: Stack(
              children: <Widget>[
                Stack(
                  children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            Pin(size: 104.0, middle: 0.7034),
            child: XDComponent71(),
          ),
          Pinned.fromPins(
            Pin(size: 56.4, start: 43.1),
            Pin(size: 32.8, middle: 0.6842),
            child: XDComponent81(),
          ),
          Align(
            alignment: Alignment(-0.197, 0.362),
            child: SizedBox(
              width: 34.0,
              height: 33.0,
              child: PageLink(
          ...
          Pinned.fromPins(
            ...
            Pin(size: 41.0, middle: 0.6784),
            child: XDComponent121(),
          ),
          Align(
            alignment: Alignment(0.281, 0.368),
            child: SizedBox(
              width: 45.0,
              height: 35.0,
              child: Stack(
          ...
          Align(
            alignment: Alignment(0.553, -0.436),
            child: SizedBox(
              width: 87.0,
              height: 16.0,
              child: Stack(
          ...
          Align(
            alignment: Alignment(-0.628, 0.099),
            child: SizedBox(
              width: 32.0,
              height: 24.0,
              child: Stack(
          ...
          Align(
            alignment: Alignment(0.634, 0.106),
            child: SizedBox(
              width: 49.0,
              height: 29.0,
              child: Stack(
          ...
          Align(
            alignment: Alignment(-0.394, 0.098),
            child: SizedBox(
              width: 25.0,
              height: 25.0,
              child: Stack(
          ...
          Align(
            alignment: Alignment(-0.268, -0.438),
            child: SizedBox(
              width: 64.0,
              height: 19.0,
              child: Stack(
          ...
          Container(),
          Pinned.fromPins(
            Pin(size: 40.1, end: 16.0),
            Pin(size: 40.1, middle: 0.2781),
            child:
          ...
          Container(),
          Pinned.fromPins(
            Pin(size: 28.0, middle: 0.3562),
            Pin(size: 12.0, start: 174.0),
            child: Text(
              'Posts',
              style: TextStyle(
          ...
          Pinned.fromPins(
            Pin(size: 52.0, middle: 0.7009),
            Pin(size: 27.0, start: 159.0),
            child: Stack(
              children: <Widget>[
                Align(
          ...
          Pinned.fromPins(
            Pin(size: 13.7, end: 19.3),
            Pin(size: 17.1, start: 202.5),
            child: PageLink(
              links: [
                PageLinkInfo(
                  transition: LinkTransition.SlideRight,
          ...
          Pinned.fromPins(
            ...
            Pin(size: 12.0, middle: 0.2053),
            child: Text(
              'I’m a student and I love to travel.',
              style: TextStyle(
                fontFamily: 'Helvetica Neue',
                fontSize: 10,
                color: const Color(0xffffffff),
          ...
          Pinned.fromPins(
            Pin(size: 51.0, middle: 0.4444),
            Pin(size: 12.0, start: 205.0),
            child: Text(
              'Edit Profile',
              style: TextStyle(
                fontFamily: 'Helvetica Neue',
          ...
          Pinned.fromPins(
            Pin(size: 105.0, middle: 0.434),
            Pin(size: 20.6, start: 200.4),
            child: XDComponent131(),
          ),
          Pinned.fromPins(
            Pin(size: 105.0, end: 45.0),
            Pin(size: 20.0, start: 201.0),
            child: XDComponent131(),
          ),
          Pinned.fromPins(
          ...
          Pinned.fromPins(
            ...
            Pin(size: 70.0, start: 151.0),
            child:
                // Adobe XD layer: '2400d3f920d559c4ae0…' (shape)
                Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage(''),
          ...
          Align(
            alignment: Alignment(0.003, -0.513),
            child: SizedBox(
              width: 54.0,
              height: 18.0,
              child: Text(
...
const String _svg_mriojw =
    '<svg viewBox="0.4 0.4 12.9 16.3" ><path transform="translate(-0.35, -0.35)" d="M 13.64342403411865 3.430213212966919 L 13.64342403411865 16.54241943359375 C 13.64342403411865 16.940185546875 13.19070339202881 17.16837882995605 12.87039375305176 16.93285751342773 C 11.51746082305908 15.93582248687744 10.1650505065918 14.93931007385254 8.812116622924805 13.94227313995361 C 8.343169212341309 13.59684467315674 7.873174667358398 13.25036716461182 7.403703212738037 12.9044132232666 C 7.277046680450439 12.81125354766846 7.104855060577393 12.81125354766846 6.978720664978027 12.9044132232666 C 6.509250164031982 13.25036716461182 6.03925609588623 13.59684467315674 5.570309162139893 13.94227313995361 C 4.216851234436035 14.93931007385254 2.864964485168457 15.93582248687744 1.511507034301758 16.93285751342773 C 1.191722631454468 17.16837882995605 0.7390000820159912 16.940185546875 0.7390000820159912 16.54241943359375 L 0.7390000820159912 3.430213212966919 C 0.7390000820159912 1.943817615509033 1.943817615509033 0.7390000820159912 3.430213212966919 0.7390000820159912 L 10.95221138000488 0.7390000820159912 C 12.43860626220703 0.7390000820159912 13.64342403411865 1.943817615509033 13.64342403411865 3.430213212966919 Z" fill="#ffffff" stroke="#ffffff" stroke-width="0.5" stroke-miterlimit="10" stroke-linecap="round" /></svg>';
const String _svg_hpjdyy =
    '<svg viewBox="0.0 100.0 396.0 1.0" ><path transform="translate(0.0, 100.0)" d="M 0 1 L 78.11720275878906 0.802734375 L 396 0" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_b39hv1 =
    '<svg viewBox="317.0 42.0 1.0 1.0" ><path transform="translate(-79.0, 42.0)" d="M 396 0" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
