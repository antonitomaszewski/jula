...
class XDWid11 extends StatelessWidget {
  XDWid11({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Stack(
            children: <Widget>[
              Container(
                ...
                margin: EdgeInsets.fromLTRB(-570.0, 0.0, -471.0, 0.0),
              ),
              Container(
                decoration: BoxDecoration(
          ...
          Align(
            alignment: Alignment(-0.259, -0.207),
            child: SizedBox(
              width: 35.0,
              height: 64.0,
              child: Stack(
                children: <Widget>[
                  Padding(
                    padding: EdgeInsets.fromLTRB(0.0, 0.0, 0.0, 18.9),
          ...
          Align(
            alignment: Alignment(0.463, 0.165),
            child: SizedBox(
              width: 20.0,
              height: 31.0,
              child: Transform.rotate(
          ...
          Align(
            alignment: Alignment(-0.218, 0.421),
            child: SizedBox(
              width: 20.0,
              height: 31.0,
              child: Transform.rotate(
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                // Adobe XD layer: 'button_back' (group)
                Stack(
                  children: <Widget>[
                ...
                Center(
                  child: SizedBox(
                    ...
                    height: 24.0,
                    child:
                        // Adobe XD layer: 'menu-5-line' (group)
                        Stack(
                      children: <Widget>[
                        SizedBox.expand(
                            child: SvgPicture.string(
          ...
          Pinned.fromPins(
            ...
            Pin(size: 126.0, end: 116.0),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 5.0, end: 5.0),
                  Pin(size: 75.0, middle: 0.3922),
                  child:
                ...
                Container(
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: const Color(0xd8000588),
                        offset: Offset(0, 0),
                        blurRadius: 10,
                      ),
                    ],
                  ),
                  margin: EdgeInsets.fromLTRB(0.0, 0.0, 0.0, 41.0),
                ),
                Align(
                  alignment: Alignment.bottomCenter,
                  child: SizedBox(
                    ...
                    height: 20.0,
                    child:
                        // Adobe XD layer: 'FIND MY WAY' (text)
                        Text(
                      'Luxury',
                      style: TextStyle(
                        fontFamily: 'Poppins',
          ...
          Pinned.fromPins(
            Pin(size: 85.0, start: 40.0),
            Pin(size: 136.0, end: 116.0),
            child: Stack(
              children: <Widget>[
                // Adobe XD layer: 'Rectangle' (shape)
                Container(
                  ...
                  margin: EdgeInsets.fromLTRB(5.0, 30.0, 5.0, 31.0),
                ),
                Stack(
                  children: <Widget>[
                    Pinned.fromPins(
