...
import './xd_profile_place.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDProfilePlace1 extends StatelessWidget {
  XDProfilePlace1({
    Key? key,
  }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Padding(
            padding: EdgeInsets.fromLTRB(-1.0, 29.0, -2.0, -17.8),
          ...
          Pinned.fromPins(
            ...
            Pin(size: 296.0, middle: 0.6055),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 26.5, end: 28.1),
                  Pin(size: 68.0, end: 0.0),
                  child: Text(
                    'Very interesting to go see it if you are aa art lover. Interesting options of free events, food and good time! Good unknown artists.\n',
                    style: TextStyle(
                ...
                Pinned.fromPins(
                  Pin(size: 65.0, middle: 0.7753),
                  Pin(size: 16.0, start: 12.5),
                  child: Stack(
                    children: <Widget>[
                      SizedBox.expand(
                          child: Text(
                ...
                Pinned.fromPins(
                  Pin(size: 135.4, start: 53.3),
                  Pin(size: 20.7, start: 8.5),
                  child: Stack(
                    children: <Widget>[
                      Pinned.fromPins(
                                                ...
                                                children: <Widget>[
                                                  Pinned.fromPins(
                                                    ...
                                                    Pin(
                                                        ...
                                                        endFraction: 0.035),
                                                    child:
                                                        // Adobe XD layer: 'a26174e27e0b7650f08…' (shape)
                                                        Container(
                                                      decoration: BoxDecoration(
                                                ...
                                                children: <Widget>[
                                                  Pinned.fromPins(
                                                    ...
                                                    Pin(
                                                        ...
                                                        endFraction: 0.035),
                                                    child:
                                                        // Adobe XD layer: '601243edf58d36e7cc2…' (shape)
                                                        Container(
                                                      decoration: BoxDecoration(
                                                        image: DecorationImage(
                                                          image:
          ...
          Align(
            alignment: Alignment(-0.628, 0.437),
            child: SizedBox(
              width: 32.0,
              height: 24.0,
              child: Stack(
          ...
          Align(
            alignment: Alignment(0.634, 0.446),
            child: SizedBox(
              width: 49.0,
              height: 29.0,
              child: Stack(
          ...
          Align(
            alignment: Alignment(-0.394, 0.436),
            child: SizedBox(
              width: 25.0,
              height: 25.0,
              child: Stack(
          ...
          Align(
            alignment: Alignment(0.554, -0.368),
            child: SizedBox(
              width: 64.0,
              height: 16.0,
              child: Stack(
          ...
          Align(
            alignment: Alignment(0.554, 0.528),
            child: SizedBox(
              width: 64.0,
              height: 16.0,
              child: PageLink(
          ...
          Pinned.fromPins(
            Pin(size: 35.0, end: 28.2),
            Pin(size: 35.0, middle: 0.31),
            child:
          ...
          Align(
            alignment: Alignment(-0.628, -0.192),
            child: SizedBox(
              width: 32.0,
              height: 24.0,
              child: Stack(
          ...
          Pinned.fromPins(
            Pin(size: 32.2, middle: 0.1859),
            Pin(size: 23.9, end: 166.4),
            child: Stack(
              children: <Widget>[
                Stack(
                  children: <Widget>[
          ...
          Align(
            alignment: Alignment(0.634, -0.185),
            child: SizedBox(
              width: 49.0,
              height: 29.0,
              child: Stack(
          ...
          Pinned.fromPins(
            Pin(size: 49.1, middle: 0.8172),
            Pin(size: 28.6, end: 159.8),
            child: Stack(
              children: <Widget>[
                Stack(
                  children: <Widget>[
          ...
          Align(
            alignment: Alignment(-0.394, -0.193),
            child: SizedBox(
              width: 25.0,
              height: 25.0,
              child: Stack(
          ...
          Pinned.fromPins(
            Pin(size: 24.7, middle: 0.3028),
            Pin(size: 24.6, end: 166.4),
            child: Stack(
              children: <Widget>[
                Stack(
                  children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            child: Text(
              'This place never disappoints me. Amazing art, amazing people, music. ',
              style: TextStyle(
                fontFamily: 'Neue Haas Grotesk Display Pro',
                fontSize: 15,
                color: const Color(0xffffffff),
          ...
          Pinned.fromPins(
            Pin(start: 26.5, end: 26.5),
            Pin(size: 34.0, middle: 0.8109),
            child: Text(
              'I only have great experiences with this place, amazing people, cool performances!',
              style: TextStyle(
                fontFamily: 'Neue Haas Grotesk Display Pro',
                fontSize: 15,
                color: const Color(0xffffffff),
...
const String _svg_dv3vid =
    '<svg viewBox="-1.0 29.0 396.0 1164.8" ><path transform="translate(-1.0, 29.0)" d="M 0 0 L 396 0 L 396 1164.84423828125 L 0 1164.84423828125 L 0 0 Z" fill="#000000" stroke="#000000" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
