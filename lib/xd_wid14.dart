...
class XDWid14 extends StatelessWidget {
  XDWid14({
    Key? key,
  }) : super(key: key);
  @override
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                      ...
                      child: Stack(
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(46.0, 0.0, 94.0, 0.0),
                          ),
                          Pinned.fromPins(
                            Pin(size: 205.0, end: -141.0),
                            Pin(size: 63.0, middle: 0.5663),
                            child:
                                // Adobe XD layer: '2019_24' (shape)
                                Container(
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  image: const AssetImage(''),
                ...
                Pinned.fromPins(
                  Pin(size: 37.0, end: 27.0),
                  Pin(size: 25.0, middle: 0.6245),
                  child: Text(
                    '23 \$',
                    style: TextStyle(
                      fontFamily: 'Poppins',
                ...
                Pinned.fromPins(
                  Pin(size: 45.0, end: 27.0),
                  Pin(size: 17.0, middle: 0.8303),
                  child: Text(
                    '6.3 kms',
                    style: TextStyle(
                      fontFamily: 'Poppins',
