...
import './xd_home13.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDHome14 extends StatelessWidget {
  XDHome14({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromPins(
                    ...
                    Pin(size: 30.3, middle: 0.4209),
                    child: Stack(
                      children: <Widget>[
                        XDComponent131(),
                        Pinned.fromPins(
                          Pin(size: 84.5, start: 0.0),
                          Pin(start: 0.0, end: 0.0),
                          child: Stack(
                            children: <Widget>[
                              XDComponent131(),
          ...
          Align(
            alignment: Alignment(-0.215, -0.147),
            child: SizedBox(
              width: 82.0,
              height: 17.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.215, 0.071),
            child: SizedBox(
              width: 82.0,
              height: 17.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.215, 0.289),
            child: SizedBox(
              width: 82.0,
              height: 17.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.201, -0.059),
            child: SizedBox(
              width: 30.0,
              height: 17.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.201, 0.159),
            child: SizedBox(
              width: 30.0,
              height: 17.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.201, 0.372),
            child: SizedBox(
              width: 30.0,
              height: 17.0,
              child: Text(
